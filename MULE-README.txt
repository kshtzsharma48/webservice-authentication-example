...
-----------------------------------------------------------------
./src/test/java/org/mule/cxf/cxfauthenticationexample/CxfAuthenticationExampleTestCase.java
...
-----------------------------------------------------------------
./src/test/resources/cxfauthenticationexample-functional-test-config.xml

Defines the Mule configuration for the CxfAuthenticationExampleTestCase.java.
...
artifactId=cxfauthenticationexample
description=CXF Web service authentication using the Mule Security Manager
muleVersion=3.2.1
...
groupId=org.mule.cxf
basedir=/Users/evangelinamartinezruizmoreno/Mule Applications/CXF-Authentication-Example
--------------------------------------------------------------------